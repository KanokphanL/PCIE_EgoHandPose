...
def create_logger(cfg, cfg_name, phase="train"):
    ...
    final_output_dir = root_output_dir / cfg_name / time_str
    ...
    logging.basicConfig(filename=str(final_log_file), format=head, force=True)
...
def parse_args_function():
    ...
    # augmentation
    parser.add_argument('--random_vertical_flip', action='store_true', help='Random Vertical Flip, p=0.5')
    parser.add_argument('--yolox_hsv_random_aug', action='store_true', help='Random Vertical Flip, p=0.5')
    parser.add_argument('--albumentation_aug', action='store_true', help='Albumentation: Blur=0.1, MedianBlue=0.1, CoarseDropout')

    # loss type
    parser.add_argument('--loss', type=str, default="Pose3DLoss", help='Loss type')
